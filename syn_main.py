...
obj_dict = {
    ...
    2: {'folder': "flame", 'longest_min': 300, 'longest_max': 400},
} #key - class number, longest_min - 합성 물체 크기 최소값, longest_max - 합성 물체 크기 최대값
...
for i in range(len(annotations_yolo)):
    with open(os.path.join('C:\\Users\\user\\Desktop\\syn_test\\result.txt'), "a") as f:
